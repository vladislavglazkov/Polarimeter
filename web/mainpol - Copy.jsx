    ...
    reader.releaseLock();
        ...
        class Experiment extends React.Component{
            ...
            async flow(atz){
                ...
                this.setState({ongoing:true});
                let varrr=await this.FindCoarse(40,3);
                if (cancelRequest){
                    cancelRequest=false;
                    //cancelPromise();
                    this.setState({ongoing:false});
                ...
                let varrr2=await this.Refine2(rfn1);
                if (cancelRequest){
                    cancelRequest=false;
                    //cancelPromise();
                    this.setState({cancellable:false});
...
console.log(res);
                    ...
                    <div className="sample" >
                        ...
                        <RotationInfo exp={this.flow.bind(this,true)} inactive={this.state.ongoing}></RotationInfo>   
                    </div>
        ...
        class RotationInfo extends React.Component{
            ...
            async autodetect(){
                ...
                GlobalData.val2=res2-res1;
                this.savedParams.val2=(res2-res1).toString();
                this.savedParams.val1=(180/(res2-res1)).toFixed(2);
                this.data=structuredClone(this.savedParams);
